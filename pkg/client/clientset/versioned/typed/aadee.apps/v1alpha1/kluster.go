...
import (
	...
	scheme "github.com/obaydullahmhs/sample-controller/pkg/client/clientset/versioned/scheme"
...
func newKlusters(c *AadeeV1alpha1Client, namespace string) *klusters {
	return &klusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
