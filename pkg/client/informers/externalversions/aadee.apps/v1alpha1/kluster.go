...
import (
	...
	aadeeappsv1alpha1 "github.com/obaydullahmhs/sample-controller/pkg/apis/aadee.apps/v1alpha1"
	...
	v1alpha1 "github.com/obaydullahmhs/sample-controller/pkg/client/listers/aadee.apps/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AadeeV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AadeeV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&aadeeappsv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aadeeappsv1alpha1.Kluster{}, f.defaultInformer)
}
